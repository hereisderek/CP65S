 ...
 *
 * Disassembly of ./aml_dump/SSDT-4.aml, Sun Aug 20 00:59:35 2017
 *
...
DefinitionBlock ("", "SSDT", 1, "HASEE ", "PARADISE", 0x00003000)
{
     ...
     * disassembly, but only 10 were resolved (4 unresolved). Additional
    ...
    External (_SB_.PCI0.LPCB.EC__.OEM2, IntObj)    // Warning: Unknown object
    External (_SB_.PCI0.LPCB.EC__.WINF, UnknownObj)    // Warning: Unknown object
    ...
    External (_SB_.WMI_, UnknownObj)    // Warning: Unknown object
    External (_SB_.WMI_.EVNT, UnknownObj)    // Warning: Unknown object
    External (_SB_.WMI_.HKDR, IntObj)    // Warning: Unknown object
