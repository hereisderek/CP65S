 ...
 *
 * Disassembly of ./aml_dump/DSDT.aml, Sun Aug 20 00:59:35 2017
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00011EBE (73406)
 *     Revision         0x02
 *     Checksum         0xE0
 *     OEM ID           "Apple "
 ...
 */
DefinitionBlock ("", "DSDT", 2, "Apple ", "PARADISE", 0x00000038)
{
    /*
     * iASL Warning: There were 21 external control methods found during
     * disassembly, but only 10 were resolved (11 unresolved). Additional
    ...
    External (_SB_.PCI0.IGPU, UnknownObj)    // Warning: Unknown object
    ...
    External (_SB_.PCI0.IGPU.GSSE, UnknownObj)    // Warning: Unknown object
    External (_SB_.PCI0.IGPU.LCD0, UnknownObj)    // Warning: Unknown object
    ...
    External (IGPU, UnknownObj)    // Warning: Unknown object
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xC97A8C18, 0x02C1)
    ...
    Device (_SB.TPM)
    {
        ...
        Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
        {
            If (LEqual (TTPF, One))
            {
                CreateDWordField (CRST, \_SB.TPM._Y35._BAS, MTFD)  // _BAS: Base Address
                CreateDWordField (CRST, \_SB.TPM._Y35._LEN, LTFD)  // _LEN: Length
