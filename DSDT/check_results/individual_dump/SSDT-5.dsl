 ...
 *
 * Disassembly of ./aml_dump/SSDT-5.aml, Sun Aug 20 00:59:35 2017
 *
...
DefinitionBlock ("", "SSDT", 1, "HASEE ", "PARADISE", 0x00001000)
{
    ...
    External (_SB_.PCI0.LPCB.EC__.DGPU, UnknownObj)    // Warning: Unknown object
    ...
    Scope (\_SB.PCI0.PEG0)
    {
        ...
        {
            Store (Add (Add (\XBAS (0x8000), Zero, Arg0), Zero, Local7), OperationRegion (PCI0, SystemMemory, Local7, One))
